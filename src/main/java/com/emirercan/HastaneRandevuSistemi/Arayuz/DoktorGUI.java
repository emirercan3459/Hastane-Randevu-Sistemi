...
public class DoktorGUI extends JFrame {
    ...
    public DoktorGUI() {
        setTitle("com.emirercan.Doktor İşlemleri");
        setSize(400, 350);
    ...
    private void doktorEkleFormu() {
        ...
        int secim = JOptionPane.showConfirmDialog(this, mesaj, "Yeni Doktor Ekle", JOptionPane.OK_CANCEL_OPTION);
        ...
        if (secim == JOptionPane.OK_OPTION) {
            ...
            JOptionPane.showMessageDialog(this, "✅ Doktor eklendi: " + yeni.getAd() + " " + yeni.getSoyad() + " (" + yeni.getBrans() + ")");
        }
    }
